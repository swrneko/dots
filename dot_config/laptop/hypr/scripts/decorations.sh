...
then
  ...
  then
    ...
    sed -i '100i\    resize_on_border = true' ~/.config/hypr/hyprland.conf # Добавление на 100 строку конфига hyprland режима изменение размера на границе окон
    ...
    sed -i '/resize_on_border = true/d' ~/.config/hypr/hyprland.conf # Удаление 100 строки конфига hyprland режима изменение размера на границе окон
